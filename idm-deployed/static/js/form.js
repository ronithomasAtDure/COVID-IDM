class form {
  ...
  applyIronSlider() {
    ...
    $("#inpuproportionOxygenslider").ionRangeSlider({
      min: 0,
      grid: false,
      step: 0.01,
      max: 1,
    ...
    $("#inpuproportionHospitalslider").ionRangeSlider({
      min: 0,
      grid: false,
      step: 0.01,
      max: 1,
...
$('form[name="simulationform"]').submit(function (event) {
  var mymodal = document.getElementById("mymodal");
  var fpd = moment(document.getElementById("inputfpd").value, "DD-MM-YYYY").format("YYYY-MM-DD");
  // console.log(fpd);
  var spd = moment(document.getElementById("inputspd").value, "DD-MM-YYYY").format("YYYY-MM-DD");
  var rm = document.getElementById("inputherm").value;
  var rmsd = moment(document.getElementById("inputsd").value, "DD-MM-YYYY").format("YYYY-MM-DD");
  var rmed = moment(document.getElementById("inputed").value, "DD-MM-YYYY").format("YYYY-MM-DD");
  var vcov = document.getElementById("inputhpc").value;
  var vdur = document.getElementById("inputhvd").value;
  var fvdate = "2021-08-31";
  var fvd = moment(document.getElementById("inputfvd").value, "DD-MM-YYYY").format("YYYY-MM-DD");
  ...
  if ((Date.parse(spd) <= Date.parse(fpd))) {
    ...
    document.getElementById("modal-msg").innerHTML = "Error: First wave peak should be earlier than second wave peak";
  ...
  // else if ((Date.parse(fpd) > Date.parse(spd))) {
  //   mymodal.style.display = "block";
  //   // alert("Restriction First Peak date should be greater than Second Peak date");
  //   document.getElementById("modal-msg").innerHTML = "First Peak date should not be later than Second Peak date";
  //   // This will prevent form being submitted. 
  //   event.preventDefault();
  // }

  // else if ((Date.parse(fvd) != " ")) {
  //   console.log(fvd);
  //   mymodal.style.display = "block";
  //   document.getElementById("modal-msg").innerHTML = "Please enter transmissibility or third wave immune escape";
  //   // This will prevent form being submitted. 
  ...
  // }
    ...
    mymodal.style.display = "block";
    document.getElementById("modal-msg").innerHTML = "Please enter a future variant date later than 31 Aug 2021";
    // alert("Lockdown End date should be greater than Lockdown Start date");
    // This will prevent form being submitted. 
    event.preventDefault();
    $('#modalbtn').on('click', function (e) {
    ...
    mymodal.style.display = "block";
    document.getElementById("modal-msg").innerHTML = "Error: restrictive measure end date should be later than restrictive measure start date";
    // alert("Lockdown End date should be greater than Lockdown Start date");
    // This will prevent form being submitted. 
    event.preventDefault();
    $('#modalbtn').on('click', function (e) {
    ...
    mymodal.style.display = "block";
    document.getElementById("modal-msg").innerHTML = "Error: Please enter an end date for restrictive measures";
    // alert("Lockdown End date should be greater than Lockdown Start date");
    // This will prevent form being submitted. 
    event.preventDefault();
    $('#modalbtn').on('click', function (e) {
    ...
    mymodal.style.display = "block";
    document.getElementById("modal-msg").innerHTML = "Error: Please enter a start date for restrictive measures";
    // alert("Lockdown End date should be greater than Lockdown Start date");
    // This will prevent form being submitted. 
    event.preventDefault();
    $('#modalbtn').on('click', function (e) {
    ...
    mymodal.style.display = "block";
    document.getElementById("modal-msg").innerHTML = "Please enter Restriction dates”";
    // alert("Lockdown End date should be greater than Lockdown Start date");
    // This will prevent form being submitted. 
    event.preventDefault();
    $('#modalbtn').on('click', function (e) {
    ...
    mymodal.style.display = "block";
    document.getElementById("modal-msg").innerHTML = "Please enter Vaccination Duration to achieve the coverage";
    // alert("Lockdown End date should be greater than Lockdown Start date");
    // This will prevent form being submitted. 
    event.preventDefault();
    $('#modalbtn').on('click', function (e) {
  ...
  // }
    ...
    mymodal.style.display = "block";
    document.getElementById("modal-msg").innerHTML = "Please enter a valid date of emergence for the future variant";
    // alert("Lockdown End date should be greater than Lockdown Start date");
    // This will prevent form being submitted. 
    event.preventDefault();
    $('#modalbtn').on('click', function (e) {
    ...
    mymodalp.style.display = "block";
    document.getElementById("modal-msgp").innerHTML = "Please wait while calibrating, the model (usually takes approx. 1 min)";
    // mymodalp.style.display = "block";
    $('#modalbtnp').on('click', function (e) {
      e.preventDefault();
      mymodalp.style.display = "none";
      // event.preventDefault();
