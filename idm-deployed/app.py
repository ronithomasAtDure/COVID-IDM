...
def plot(place, seropeak, FirstPeaktDate,  fCases, SecondPeaktDate, sCases,
                ...
                proportionHospital, proportionOxygen, homecare):
    ...
    print(seromsg,all_end_index,preparedness)
    if seromsg == "no":
        seroAlert = "hide"
    else:
        seroAlert = ""
    ...
    if seromsg=="no":
        ...
        print("Preparedness",preparedness)
        return graphJSON, wavestatus, preparedness, seroAlert
    
    else:
        print("Preparedness",preparedness)
        return None,0,preparedness,seroAlert
...
class defaultPlot():
    place = "India"
    seropeak = 8.1
    FirstPeaktDate = "17-09-2020"
    fCases = 93180
    SecondPeaktDate = "06-05-2021"
    sCases = 391232
    checktrans = ""
    trans = 0
    # check = ""
    ...
    vaccDays = 0
    vaccCover = 0
    proportionHospital, proportionOxygen, homecare = 1,1,None
...
def advanced_dashboard():
    if request.method == "POST":
        ...
        graphJSON, wavestatus, preparedness,seroAlert = plot(place, seropeak, FirstPeaktDate,  fCases, SecondPeaktDate, sCases,
                    trans, wa, thie, ThirdWaveEmergenceDate , LockdownStartDate, LockdownEndDate, rm, popdens, vaccDays, vaccCover,
                    proportionHospital, proportionOxygen, homecare)
        fvalert,fvalertmsg  = "hide",""        
        # except IndexError:
        #     print (IndexError)
        #     fvalert = ""
        #     fvalertmsg = 'Please double check that all input values are consistent'
        #     graphJSON, wavestatus, preparedness,seroAlert =   "",0,[0]*12,"hide"
        # except:
        #     fvalert = ""
        #     fvalertmsg = 'Please double check that all input values are consistent'
        #     graphJSON, wavestatus, preparedness,seroAlert =   "",0,[0]*12,"hide"
